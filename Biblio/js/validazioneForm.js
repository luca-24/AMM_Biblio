    ...
    $("#buttonCercaLibro").on("click", function()
    {
        ...
        {   
          if($("#ruolo").val() == 'lettore')
                $("#formCercaLibro").attr("action", "/Biblio/php/controller/loggedIn/lettore/cercaLibro.php");
            else if($("#ruolo").val() == 'bibliotecario')
                $("#formCercaLibro").attr("action", "/Biblio/php/controller/loggedIn/bibliotecario/cercaNelCatalogo.php");
        }    
  ...
  //  action=\"/Biblio/php/controller/loggedIn/lettore/cercaLibro.php\"
   // action=\"/Biblio/php/controller/loggedIn/bibliotecario/cercaNelCatalogo.php\"
    ...
    $("#buttonCercaBiblioL").on("click", function()
    {
        ...
        {           
            $("#formCercaBiblioL").attr("action", "/Biblio/php/controller/loggedIn/lettore/cercaBiblioteca.php") ;
        }    
    ...
    $("#buttonAggiungiLibro").on("click", function()
    {
        ...
        {           
            $("#formAggiungiLibro").attr("action", "/Biblio/php/controller/loggedIn/bibliotecario/bibliotecarioController.php") ;
    ...
    $("#submitL").on("click", function()
     {      
        ...
        $.ajax(
        {
            url: "/Biblio/php/controller/loggedOut/checkEmail.php",
            data: 
            {
                email : emailL        
            },
        ...
        else if(esisteGia==true)
        {
         ...
         else if(invalidMail == true)
         {
            ...
            {
                $("#registrazioneL").attr("action", "/Biblio/php/controller/loggedOut/loggedOutController.php");   
     ...
     {      
        ...
        else if(invalidMail==true)
        {
            ...
            {
                $("#registrazioneB").attr("action", "/Biblio/php/controller/loggedOut/loggedOutController.php");   
